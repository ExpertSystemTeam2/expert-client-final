      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Flex justifyContent={"center"} p={10}>
          <Button
            ...
            type="submit"
            onClick={() => [
              setNilai1(Data[1].nilai),
              // setNilai2(Data[2].nilai),
              // setNilai3(Data[3].nilai),
              // setNilai4(Data[4].nilai),
              // setNilai5(Data[5].nilai),
            ]}
          >
            Next
          </Button>
